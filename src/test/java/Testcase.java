...
//         webDriver.navigate().to("http://zero.webappsecurity.com/login.html");                          //hum navigate ur get dono use kr saktaa han
//
//
//
//        //set the user name
//
//
//         WebElement textbox_username=webDriver.findElement(By.id("user_login"));
//
...
//
//
//         WebElement textbox_password=webDriver.findElement(By.id("user_password"));
//
//         textbox_password.sendKeys("password");
//
//         //////////////////hum an iss ma xpath sa krtaa han ...q k hum id ,name  ya phir xpath sab sa kr saktaa han
//
//      webDriver.findElement(By.xpath("//*[@id=\"login_form\"]/div[2]/input")).click();;    /////ya submit button ha
//
//
...
//         Assert.assertEquals(Expected,Actual);
         ...
         //webDriver.navigate().to("http:seleniumimplified.com//");
